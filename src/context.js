...
class ProductProvider extends Component {
  ...
  setProducts = () => {
    //   we need this because grabbing storeProducts and placing them in state, we are
    // just grabbing the actual reference to the data, and changing it through life cycle
    // of app. We should be COPYING the storeProducts, that way we do not change the data.
    let tempProducts = []
  ...
  addToCart = id => {
    ...
    // spread function gives us a reference to all of the products
